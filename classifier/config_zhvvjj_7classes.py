...
vars = [
    ...
    "jet1_p_{}".format(tag),
    "jet2_p_{}".format(tag),
    "jet1_theta_{}".format(tag),
    "jet2_theta_{}".format(tag),
    "M_jj_{}".format(tag),
    "Mrec_jj_{}".format(tag),
    "M_vis_{}".format(tag),
    "P_vis_{}".format(tag),
    "P_inv_{}".format(tag),
    "M_inv_{}".format(tag),
    "costhetainv_{}".format(tag),
    "M_vis_corr1_{}".format(tag),
    "M_vis_corr2_{}".format(tag),
    "event_nel_{}".format(tag),
    "event_nmu_{}".format(tag),
]
